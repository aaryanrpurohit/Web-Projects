    ...
    return (
        <nav className='flex m-7 justify-between h-10'>
            ...
            <div className="flex justify-center items-center gap-3">
                <img src="/src/assets/icons/shield.png" className='p-1 rounded-xl cursor-pointer w-9.5 border-[#0e2240] border-2 logo hover:scale-115 transition-scale duration-200' />
